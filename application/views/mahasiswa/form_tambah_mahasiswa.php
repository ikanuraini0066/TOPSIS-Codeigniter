                        ...
                        <div class="p-5">
                            ...
                            <form method="POST" action="<?php echo base_url('data_mahasiswa/tambah_mahasiswa_aksi') ?>">
                                ...
                                <div class="form-group">
                                    <input type="text" name="id_mahasiswa" class="form-control form-control-user" placeholder="Id Mahasiswa">
                                    <?php echo form_error('id_mahasiswa', '<div class="text-small text-danger">', '</div>') ?>
                                </div>

                                <div class="form-group">
                                    <input type="text" name="nama_mahasiswa" class="form-control form-control-user" placeholder="Nama Mahasiswa">
